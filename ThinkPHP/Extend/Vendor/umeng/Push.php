...
class Push {
	protected $appkey           = '568b459567e58e5a1d000400'; 
	protected $appMasterSecret     = 'qf6rnm4h0pouzyqettpgn7lrb39dn7hu';
...
//发送广播
	function sendAndroidBroadcast($content) {
		try {
			$brocast = new AndroidBroadcast();
			$brocast->setAppMasterSecret($this->appMasterSecret);
			$brocast->setPredefinedKeyValue("appkey",           $this->appkey);
			$brocast->setPredefinedKeyValue("timestamp",        $this->timestamp);
			$brocast->setPredefinedKeyValue("ticker",           $content['ticker']);
			$brocast->setPredefinedKeyValue("title",            $content['title']);
			$brocast->setPredefinedKeyValue("text",             $content['text']);
    ...
    //单播
	function sendAndroidUnicast($device_tokens,$content) {
		try {
			...
			$unicast->setPredefinedKeyValue("ticker",           $content['ticker']);
			$unicast->setPredefinedKeyValue("title",            $content['title']);
			$unicast->setPredefinedKeyValue("text",             $content['text']);
	...
	function sendAndroidFilecast() {
		try {
			...
			$filecast->setPredefinedKeyValue("ticker",           $content['ticker']);
			$filecast->setPredefinedKeyValue("title",            $content['title']);
			$filecast->setPredefinedKeyValue("text",             $content['text']);
	...
	function sendAndroidGroupcast($channel='DiDi',$content) {
		try {
			/* 
			...
			$groupcast->setPredefinedKeyValue("ticker",           $content['ticker']);
			$groupcast->setPredefinedKeyValue("title",            $content['title']);
			$groupcast->setPredefinedKeyValue("text",             $content['text']);
