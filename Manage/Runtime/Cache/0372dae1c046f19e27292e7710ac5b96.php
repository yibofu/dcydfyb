...
<body>
	<table id="dg" class="easyui-datagrid" toolbar="#toolbar" style="width:90%px;height:80%px"
		...
		<thead>
			<tr>
				<th field="order_num" align="center">订单号</th>
				<th field="uid" align="center">用户id</th>
				<th field="nickname" align="center">用户昵称</th>
				<th field="type" align="center">礼物种类</th>
				<th field="gift_name" align="center">礼物名称</th>
				<th field="money" align="center">礼物金额</th>
				<th field="receive_id" align="center">收礼人id</th>
				<th field="receive_name" align="center">收礼人昵称</th>
				<th field="bank" align="center">消费银行</th>
				...
				<th field="ctime" align="center">送礼时间</th>
			</tr>
		</thead>
	</table>
	<div id="toolbar" style="height:70px;">
		<div>
				<table>
					<tr>
						<td>订单号：<input class="easyui-validatebox" id="order_num" type="text" name="order_num" size='4'></td>
						...
						<td>礼品名称：<input class="easyui-validatebox" id="gift_name" type="text" name="gift_name" size="5" ></td>
						<td>礼品金额：<input class="easyui-validatebox" id="money" type="text" name="money" size="5" ></td>
						<td>消费银行：<input class="easyui-validatebox" id="bank" type="text" name="bank" size="5" ></td>
