...
>
    ...
    <tr>
        ...
        <th field="explain" align="center" width="20%">老师信息</th>
        <th field="timg" align="center" width="10%" formatter="imgFormatter">老师图片</th>
        <th field="limg" align="center" width="10%" formatter="imgFormatter">老师列表圆形图片</th>
        <th field="traders" align="center" width="20%">操盘案例</th>
...
<!--新增-->
<div id="dlg" class="easyui-dialog" title="设置" closed="true" buttons="#dlg-button" style="width:700px;height:500px;">
    <form id="fm" method="post" enctype="multipart/form-data">
        ...
        <div class="fitem">
            <label>操盘案例:</label>
            <input type="text" name="traders" class="easyui-validatebox" style="width: 300px;height:150px;;">
        </div>
        <div class="fitem">
            <label>老师图片:</label>
