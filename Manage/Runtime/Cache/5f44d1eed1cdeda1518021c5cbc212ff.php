...
<table id="dg" class="easyui-datagrid" toolbar="#toolbar" style="width:90%px;height:80%px"
       data-options="
				url: '<?php echo U('Kecheng/arrangelist');?>',
				rownumbers: true,
				fit:true,
...
>
    ...
    <tr>
        ...
        <!--<th field="teacherid" align="center" width="5%">老师id</th>-->
        <th field="address" align="center" width="10%">授课地址</th>
        <!--<th field="type" align="center" width="10%">授课类型id</th>-->
        <th field="tname" align="center" width="10%">授课类型</th>
        <th field="startday" align="center" width="10%">授课开始时间</th>
        <th field="endday" align="center" width="10%">授课结束时间</th>
    ...
    <form id="fm" method="post" enctype="multipart/form-data">
        ...
        <div class="fitem">
            ...
            <select name="type" id="type" data-options="panelHeight:'auto',editable:false" class="easyui-combobox">
                ...
                <?php if(is_array($re)): $i = 0; $__LIST__ = $re;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($voo["id"]); ?>"><?php echo ($voo["tname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
        <!--<div class="fitem">-->
            <!--<label>授课天数:</label>-->
            <!--<select name="days" id="days" data-options="panelHeight:'auto',editable:false" class="easyui-combobox">-->
                <!--<option value="">&#45;&#45;请选择&#45;&#45;</option>-->
                <!--<?php if(is_array($re)): $i = 0; $__LIST__ = $re;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vov): $mod = ($i % 2 );++$i;?>-->
                    <!--<option value="<?php echo ($vov["id"]); ?>"><?php echo ($vov["days"]); ?></option>-->
        ...
        <div class="fitem">
            <label>授课讲师:</label>
            <select name="teacherid" id="teacherid" data-options="panelHeight:'auto',editable:false" class="easyui-combobox">
                <option value="">--请选择--</option>
        ...
        <!--<div class="fitem">-->
            ...
            <!--<select name="cost" id="cost" data-options="panelHeight:'auto',editable:false" class="easyui-combobox">-->
                <!--<option value="">&#45;&#45;请选择&#45;&#45;</option>-->
                <!--<?php if(is_array($re)): $i = 0; $__LIST__ = $re;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>-->
                    <!--<option value="<?php echo ($vo1["id"]); ?>"><?php echo ($vo1["cost"]); ?></option>-->
                <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
            <!--</select>-->
        <!--</div>-->
        <div id="dlg-button">
...
<script type="text/javascript">
    ...
    function add(){
        ...
        url = "<?php echo U('Kecheng/arrangeadd');?>";
    }
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if (row){
                    $('#fm').form('clear');
                    $('#dlg').dialog('open');
                    url = "<?php echo U('Kecheng/arrangesave');?>&id="+id;
                    $('#fm').form('load',row);
                }else{
                    $.messager.show({
                        title: '出错啦！！',
