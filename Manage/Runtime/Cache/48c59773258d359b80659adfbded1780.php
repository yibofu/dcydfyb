...
<table id="dg" class="easyui-datagrid" toolbar="#toolbar" style="width:90%px;height:80%px"
       data-options="
				url: '<?php echo U('Popularize/questionlist');?>',
				rownumbers: true,
				fit:true,
...
>
    ...
    <tr>
        ...
        <th field="sex" align="center" width="10%" formatter="show_sex">性别</th>
...
<script type="text/javascript">
    ...
    function del(id){
        $.ajax({
            type:'post',
            url:"__APP__/Popularize/popuquesdel",
            data:{id:id},
            success:function(data){
                row = eval('('+data+')');
                if (row){
