...
>
    ...
    <tr>
        ...
        <th field="phone" align="center" width="10%" >电话</th>
        <th field="ques" align="center" width="20%">问题标题</th>
        <th field="desc" align="center" width="15%">问题描述</th>
    ...
    <div>
        <table>
            <tr>
                ...
                <td>问题标题:<input class="easyui-validatebox" id="ques" type="text" name="ques" size="20"></td>
                <td>问题描述:<input class="easyui-validatebox" id="desc" type="text" name="ques" size="20"></td>
                <td>解决情况:
...
<script type="text/javascript">
    ...
    function show_manger(val,row){
        ...
        str = "<a href = 'javascript:;' onclick='manage("+row.id+")'>点击确认已解决</a> / " +
                ...
                "<a href='javascript:;' onclick='manage2("+row.id+")'>点击查看问题描述</a>";
        return str;
    }
