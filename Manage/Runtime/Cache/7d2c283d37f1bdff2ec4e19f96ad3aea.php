...
<table id="dg" class="easyui-datagrid" toolbar="#toolbar" style="width:90%px;height:80%px"
       data-options="
				url: '<?php echo U('Question/shtlist');?>',
				rownumbers: true,
				fit:true,
...
>
    ...
    <tr>
        ...
        <th field="phone" align="center" width="20%" >电话</th>
        <th field="time" align="center" width="30%">时间</th>
        <th field="status" align="center" width="25%" formatter="show_status">解决情况</th>
