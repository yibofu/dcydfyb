...
<body>
	<table id="dg" class="easyui-datagrid" toolbar="#toolbar" style="width:90%px;height:80%px"
			data-options="
				url: '<?php echo U('Loanshow/loanlist');?>',
				rownumbers: true,
				fit:true,
		...
		<thead>
			<tr>
				...
				<th field="check_time" > 审核通过时间 </th>
				<th field="len_time" > 放贷时间 </th>
	...
	<div id="toolbar" style="height:70px;">
		<div>
			<form  method="post" action="<?php echo U('Loan/loanlist');?>">
				<table>
					<tr>
						<td>协议编号：<input class="easyui-validatebox" id="deal_num" type="text" name="deal_num" ></td>
...
<script type="text/javascript">
	...
	function show_manage(val,row){
		return "<a href='/Manerger/index.php/Check/detail/id/"+row.id+"' target='_blank'>查看详情</a>";
	}
</script>
</html>