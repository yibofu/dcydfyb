...
<table id="dg" class="easyui-datagrid" toolbar="#toolbar" style="width:90%px;height:80%px"
       data-options="
				url: '<?php echo U('Kecheng/swjclist');?>',
				rownumbers: true,
				fit:true,
...
<script type="text/javascript">
    ...
    function add(){
        ...
        url = "<?php echo U('Kecheng/swjcadd');?>";
    }
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if (row){
                    $('#fm').form('clear');
                    $('#dlg').dialog('open');
                    url = "<?php echo U('Kecheng/swjcsave');?>&id="+id;
                    $('#fm').form('load',row);
                }else{
                    $.messager.show({
                        title: '出错啦！！',
