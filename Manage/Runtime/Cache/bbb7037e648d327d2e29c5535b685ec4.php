...
<body class="easyui-layout" style="margin: 0 auto; width:99%;">
 ...
 <!--操作演示结束，后面还要封闭div-->
	<table id="dg" class="easyui-datagrid" toolbar='#toolbar' 
			data-options="
				url: '<?php echo U('LoanManage/finlist',array('plan'=>9));?>',
				rownumbers: true,
				fit:true,
				fitColumns:true,
				singleSelect: true,
		...
		<thead>
			<tr>
				...
				<th field="check_time" align="center" width="25%">快递审核通过时间</th>
	...
	<script type="text/javascript">
		function show_manger(val,row){
			   return '<a href="__APP__/LoanManage/show_fin/id/'+row.id+'" class="easyui-linkbutton" iconCls="icon-edit" plain="true">审核</a>'; 
		}
	</script>
</html>