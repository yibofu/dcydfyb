				...
				<div class="consult_left">
					...
					<div class="expert_introduce">
						...
						<div class="teachers_introduce">
							...
							<div class="teachers_specific">
								<!--照片-->
								<div class="teachers_specific_img">
									<img src="/Public/app/img/teachers_img/lvjingjie.png" />
								</div>
								<!--右边文字-->
								<div class="teachers_specific_leftText">
									<p class="leftText_title"><span>吕定杰</span>财务健康顾问</p>
									<p class="leftText_text">企业财务管理顶尖实战专家 <br />企业财务管理顶尖实战专家<br /> <span>企业财务管理顶尖实战专家1231</sapn></p>
								</div>
								<div style="clear: both;"></div>
								<!--下边文字-->
								<div class="teachers_specific_bottomText">
									<p><span>操盘案例：</span>吕老师通过课程理论与情景模拟结合等刘老师通过课程理论与情景<a href="#">[更多]</a></p>
								</div>
							</div>
							...
							<div class="teachers_specific">
								<!--照片-->
								<div class="teachers_specific_img">
									<img src="/Public/app/img/teachers_img/zubaozhu.png" />
								</div>
								<!--右边文字-->
								<div class="teachers_specific_leftText">
									<p class="leftText_title"><span>朱宝珠</span>财务健康顾问</p>
									<p class="leftText_text">企业财务管理顶尖实战专家 <br />企业财务管理顶尖实战专家<br /> <span>企业财务管理顶尖实战专家1231</sapn></p>
								</div>
								<div style="clear: both;"></div>
								<!--下边文字-->
								<div class="teachers_specific_bottomText">
									<p><span>操盘案例：</span>朱老师通过课程理论与情景模拟结合等刘老师通过课程理论与情景<a href="#">[更多]</a></p>
								</div>
							</div>
							<div class="teachers_specific">
								<!--照片-->
								<div class="teachers_specific_img">
									<img src="/Public/app/img/teachers_img/wenjia.png" />
								</div>
								<!--右边文字-->
								<div class="teachers_specific_leftText">
									<p class="leftText_title"><span>翁嘉</span>财务健康顾问</p>
									<p class="leftText_text">企业财务管理顶尖实战专家 <br />企业财务管理顶尖实战专家<br /> <span>企业财务管理顶尖实战专家1231</sapn></p>
								</div>
								<div style="clear: both;"></div>
								<!--下边文字-->
								<div class="teachers_specific_bottomText">
									<p><span>操盘案例：</span>翁老师通过课程理论与情景模拟结合等刘老师通过课程理论与情景<a href="#">[更多]</a></p>
								</div>
							</div>
							<div class="teachers_specific">
								<!--照片-->
								<div class="teachers_specific_img">
									<img src="/Public/app/img/teachers_img/donggaozhong.png" />
								</div>
								<!--右边文字-->
								<div class="teachers_specific_leftText">
									<p class="leftText_title"><span>董高仲</span>财务健康顾问</p>
									<p class="leftText_text">企业财务管理顶尖实战专家 <br />企业财务管理顶尖实战专家<br /> <span>企业财务管理顶尖实战专家1231</sapn></p>
								</div>
								<div style="clear: both;"></div>
								<!--下边文字-->
								<div class="teachers_specific_bottomText">
									<p><span>操盘案例：</span>董老师通过课程理论与情景模拟结合等刘老师通过课程理论与情景<a href="#">[更多]</a></p>
								</div>
							</div>
							<div class="teachers_specific">
								<!--照片-->
								<div class="teachers_specific_img">
									<img src="/Public/app/img/teachers_img/fangchong.png" />
								</div>
								<!--右边文字-->
								<div class="teachers_specific_leftText">
									<p class="leftText_title"><span>方翀</span>财务健康顾问</p>
									<p class="leftText_text">企业财务管理顶尖实战专家 <br />企业财务管理顶尖实战专家<br /> <span>企业财务管理顶尖实战专家1231</sapn></p>
								</div>
								<div style="clear: both;"></div>
								<!--下边文字-->
								<div class="teachers_specific_bottomText">
									<p><span>操盘案例：</span>方老师通过课程理论与情景模拟结合等刘老师通过课程理论与情景<a href="#">[更多]</a></p>
								</div>
							</div>
							<div class="teachers_specific">
								<!--照片-->
								<div class="teachers_specific_img">
									<img src="/Public/app/img/teachers_img/xuzhike.png" />
								</div>
								<!--右边文字-->
								<div class="teachers_specific_leftText">
									<p class="leftText_title"><span>徐志珂</span>财务健康顾问</p>
									<p class="leftText_text">企业财务管理顶尖实战专家 <br />企业财务管理顶尖实战专家<br /> <span>企业财务管理顶尖实战专家1231</sapn></p>
								</div>
								<div style="clear: both;"></div>
								<!--下边文字-->
								<div class="teachers_specific_bottomText">
									<p><span>操盘案例：</span>徐老师通过课程理论与情景模拟结合等刘老师通过课程理论与情景<a href="#">[更多]</a></p>
								</div>
							</div>
							<div class="teachers_specific">
								<!--照片-->
								<div class="teachers_specific_img">
									<img src="/Public/app/img/teachers_img/caojixue.png" />
								</div>
								<!--右边文字-->
								<div class="teachers_specific_leftText">
									<p class="leftText_title"><span>曹继学</span>财务健康顾问</p>
									<p class="leftText_text">企业财务管理顶尖实战专家 <br />企业财务管理顶尖实战专家<br /> <span>企业财务管理顶尖实战专家1231</sapn></p>
								</div>
								<div style="clear: both;"></div>
								<!--下边文字-->
								<div class="teachers_specific_bottomText">
									<p><span>操盘案例：</span>曹老师通过课程理论与情景模拟结合等刘老师通过课程理论与情景<a href="#">[更多]</a></p>
								</div>
							</div>
							<div class="teachers_specific">
								<!--照片-->
								<div class="teachers_specific_img">
									<img src="/Public/app/img/teachers_img/zhaojinxuan.png" />
								</div>
								<!--右边文字-->
								<div class="teachers_specific_leftText">
									<p class="leftText_title"><span>赵进选</span>财务健康顾问</p>
									<p class="leftText_text">企业财务管理顶尖实战专家 <br />企业财务管理顶尖实战专家<br /> <span>企业财务管理顶尖实战专家1231</sapn></p>
								</div>
								<div style="clear: both;"></div>
								<!--下边文字-->
								<div class="teachers_specific_bottomText">
									<p><span>操盘案例：</span>赵老师通过课程理论与情景模拟结合等刘老师通过课程理论与情景<a href="#">[更多]</a></p>
								</div>
							</div>
						</div>
						<!--页数-->
