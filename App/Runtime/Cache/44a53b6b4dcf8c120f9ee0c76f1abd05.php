...
<div class="official-head">
    ...
    <div class="consult_main">
        ...
        <div class="consult_left">
                <p class="back_link"><a href="#">新政速递</a><span>&gt;</span><span><?php echo ($result[0]['lanmu']); ?></span></p>
            <!--内容列表-->
            <div class="text_list">
                <ul>
                    <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Article/article');?>?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a><span><?php echo ($vo["time"]); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
            <!--页数-->
            <div class="page">
