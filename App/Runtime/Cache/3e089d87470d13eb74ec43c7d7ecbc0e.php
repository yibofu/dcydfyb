...
<head>
    ...
    <link rel="stylesheet" href="/Public/app/css/text_list.css" />
    ...
    <link rel="stylesheet" href="/Public/app/css/page.css" />
...
<script>
    ...
    <div class="consult_banner">
        <img src="/Public/app/img/text_list/list_banner.png" />
    </div>
    <div class="consult_main">
        <!--内容左边的部分-->
        <div class="consult_left">
			<p class="back_link" style="margin-top:5px;"><span style="padding:5px 15px;background:#0098b3; color:#FFF">关键字</span>&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<span><?php echo ($keywords); ?></span></p>
            <!--内容列表-->
            <div class="text_list">
                <ul>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "没有相关内容" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Article/article');?>?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a><span><?php echo ($vo["time"]); ?></span></li><?php endforeach; endif; else: echo "没有相关内容" ;endif; ?>
                </ul>
            </div>
            <!--页数-->
...
<div class="menuRightcho">
    <div class="menuRightchol">
        ...
        <a href="<?php echo U('Teacher/teacherList');?>"  class="underlineNeg">
...
<script src="/Public/app/js/page.js"></script>
<script>
    //轮播
