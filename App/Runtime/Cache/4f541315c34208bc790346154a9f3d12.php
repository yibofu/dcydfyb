		...
		<div class="sign_all" style="line-height:50px;">
			...
			<div class="part_one">
				...
				<div class="apply_classes">
					...
					<p class="apply_classes_text"><span>课程名称：</span><span style="color: #666666;font-weight: 500;">公司财务分析与风险防范</span></p>
					<p class="apply_classes_text"><span>时间地点：</span><span>北京2017年05月17-19日</span><img src="/Public/app/img/menology.png"><a>点击可更改日期</a></p>
					<p class="apply_classes_text"><span>课程单价：</span><span>￥3000</span><img src="/Public/app/img/book.png"><a style="font-size: 18px;">费用说明</a></p>
				</div>
				<!--培训收益-->
			...
			<div class="training_person">
				...
				<p class="person_information"><span>*</span>姓名：<input type="text"></p>
				<p class="person_information"><span>*</span>部门：<input type="text"></p>
				<p class="person_information"><span>*</span>邮件：<input type="text"></p>
				<p class="person_information"><span>*</span>职位：<input type="text"></p>
				<p class="person_information"><span>*</span>公司：<input type="text"></p>
				<p class="person_information"><span>*</span>手机：<input type="text"></p>
			</div>
			<!--付款方式-->
			<div class="pay_style">
				<p class="pay_style_title"><img src="/Public/app/img/pay_style.png"><span>付款方式</span></p>
				<p class="bank_price"><input type="radio"id="bank_price_input"><label for="bank_price_input">银行转账</label></p>
			</div>
			<!--其他要求-->
			<div class="other_requirements">
				<p class="other_requirements_title"><img src="/Public/app/img/require.png"/><span>您的其它要求及相关说明</span></p>
				<textarea placeholder="在此填写您的其它要求，诸如发票抬头等"></textarea>
			</div>
			<!--提交信息-->
			<div class="submit_btn">
				<button>提交信息</button>
				<p><input type="checkbox" id="checkbox_submit"/><label for="checkbox_submit">我已阅读并同意《公开课参课注意事项》</label></p>
			</div>
		</div>
		<!--友情链接-->
		<!--友情链接 c02003-->
