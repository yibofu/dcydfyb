	...
	<body>
		<div class="confirmation_all">
			...
			<div class="confirmation_banner">
				<img src="img/confirmation_banner_img.png" />
			</div>
			<!--报名确认的信息-->
			<div class="confirmation_main">
				...
				<div class="confirmation_lead">
					<p>尊敬的<span>姓名</span></p>
					<p>您好。根据您的课程报名表，大财有道科技有限公司与您确认如下信息。</p>
				</div>
				<!--参课信息-->
				<p class="join_classes_title">参课信息</p>
				<div class="join_classes">
					<p><span>课程名称:</span></span>《公司财务分析与风险防范》</span></p>
					<p><span>计划时间:</span><span>上海 2017年04月19-21日<课前一周以邮件的形式通知具体授课地点></span></p>
					<p><span>参课学员:</span><span>《公司财务分析与风险防范》</span></p>
					<p><span>所属公司:</span><span>《公司财务分析与风险防范》</span></p>
				</div>
				<!--费用与付款事宜-->
				<p class="confirmation_price_title">费用与付款事宜</p>
				<div class="confirmation_price">
					<p><span>培训费用：</span><span>￥3000元/人</span></p>
				...
				<div class="apply_aggrement">
					<input type="checkbox" id="check"/><label for="check">我已阅读并同意《公开课参课注意事项》</label>
				</div>
				<!--确认按钮-->
				<div class="ack_btn">
			...
			<!--弹窗-->
			<div class="popup">
				<p class="off_btn"><img src="img/off.png"/></p>
				...
				<div class="popup_text">
					...
					<div class="popup_phone">
						<p><img src="img/popup_phone.png" /><span class="phone_number">400-810-9017</span><span class="phone_text">(客服服务热线)</span></p>
					</div>
				</div>
