...
<div class="official-head">
    ...
    <div class="consult_main">
        ...
        <div class="consult_left">
            <!--财税案例-->
            <div class="main_one">
                <p class="one_title">财税案例 <a href="#">更多</a></p>
                <div class="one_text">
                    ...
                    <div class="one_text_text">
                        <ul>
                            <li><a href="#">汇集2位知名企业财务高管共同分享行业实践经验和经典</a></li>
                            <li><a href="#">汇集2位知名企业财务高管共同分享行业实践经验和经典</a></li>
                            <li><a href="#">汇集2位知名企业财务高管共同分享行业实践经验和经典</a></li>
                            <li><a href="#">汇集2位知名企业财务高管共同分享行业实践经验和经典</a></li>
                        </ul>
            ...
            <!--财政法规-->
            <div class="main_two">
                <p class="two_title">财政法规<a href="#">更多</a></p>
                <div class="two_text">
            ...
            <div class="main_three">
                <p class="three_title">扁鹊干货<a href="#">更多</a></p>
            ...
            <!--新闻动态-->
            <div class="main_four">
                <p class="four_title">新闻动态<a href="#">更多</a></p>
                <div class="four_text">
