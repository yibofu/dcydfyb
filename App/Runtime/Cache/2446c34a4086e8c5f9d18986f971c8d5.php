    ...
    <div class="one message-one message-ini min-q bor-e">
        ...
        <div class="message-san fl">
            <div class="tab-content basic">
                ...
                <div class="content">
                    <div class="content-h3 height-c"><h3 class="fl wina"><?php echo ($rea['title']); ?></h3><a href="<?php echo U('Index/message');?>" class="fr color-b wid" id="uin">返回列表》</a><div class="clearfix"></div></div>
                    <div class="content-p fr title-d height-c min-t">
                        <p class="fl">作者：</p><p class="fl"><?php echo ($rea['auth']); ?></p><p class="fl min-c">上传时间：</p><p class="fl"><?php echo ($rea['time']); ?></p>
                        <div class="clearfix"></div>
                    </div>
                    <div class="clearfix"></div>
                    <div  id='content' class="height-j ini color-u">
                        <p><?php echo ($rea['content']); ?></p>
