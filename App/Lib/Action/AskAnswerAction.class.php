<?php
	class AskAnswerAction extends Action {
		public function Asks() {
			...
			//获取已回答问题列表
			$question = $questionModel->field('dcyd_question.type type,dcyd_question.question question, dcyd_question.id id, dcyd_answer.answer answer, dcyd_answer.teacherid teacherid, dcyd_user.img img, dcyd_user.nickname nickname ')
